    ...
    <div className="min-h-screen bg-[#FAF3E0] flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full">
        ...
        {error && (
          <div className="mb-4 p-3 bg-red-50 border border-red-200 rounded-md">
            <p className="text-red-800 text-sm">
              {error === "AccessDenied"
                ? "Access denied. Please use an authorized email address."
        ...
        <button
          ...
          className="w-full bg-[#0b3d2e] text-white py-3 px-4 rounded-md hover:bg-[#0a3426] transition-colors flex items-center justify-center gap-3 font-medium"
        >
          <svg
            className="w-5 h-5"
            viewBox="0 0 24 24"
